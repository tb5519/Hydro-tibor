...
// This intentionally has no default. An absent global value lets callers
// retain a legacy per-domain setting until the student is saved again.
AccountSetting(Schema.object({
