!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"970d75aa8607cff89eb0648ee23d6fafc2d8eca2"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="80df6176-3f29-41e0-b56f-93ec99e9aa38",e._sentryDebugIdIdentifier="sentry-dbid-80df6176-3f29-41e0-b56f-93ec99e9aa38");}catch(e){}}();
"use strict";
...
/* harmony import */ var _core_matrix_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/matrix.js */ "../../node_modules/zrender/lib/core/matrix.js");
...
var DEFAULT_ANIMATABLE_MAP = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.reduce)(_core_Transformable_js__WEBPACK_IMPORTED_MODULE_0__.TRANSFORMABLE_PROPS, function(obj, key) {
  obj[key] = true;
  return obj;
}, { ignore: false });
...
var Element = (function() {
  function Element2(props) {
    this.id = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.guid)();
    this.animators = [];
    this.currentStates = [];
    this.states = {};
    this._init(props);
    ...
    if (textEl && (!textEl.ignore || forceUpdate)) {
      ...
      if (hasPosition) {
        if (this.calculateTextPosition) {
          ...
          (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.calculateTextPosition)(tmpTextPosCalcRes, textConfig, layoutRect);
        }
        ...
        if (textOrigin && textConfig.rotation != null) {
          ...
          if (textOrigin === "center") {
            ...
            relOriginX = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.parsePercent)(textOrigin[0], layoutRect.width);
            relOriginY = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.parsePercent)(textOrigin[1], layoutRect.height);
          }
          innerOrigin = true;
      ...
      if (autoOverflowArea) {
        var overflowRect = innerTextDefaultStyle.overflowRect = innerTextDefaultStyle.overflowRect || new _core_BoundingRect_js__WEBPACK_IMPORTED_MODULE_2__["default"](0, 0, 0, 0);
        innerTransformable.getLocalTransform(tmpInnerTextTrans);
        (0,_core_matrix_js__WEBPACK_IMPORTED_MODULE_9__.invert)(tmpInnerTextTrans, tmpInnerTextTrans);
  ...
  Element2.prototype.attrKV = function(key, value) {
    if (key === "textConfig") {
      ...
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)(this.extra, value);
    } else {
      this[key] = value;
    }
  };
  ...
  Element2.prototype.attr = function(keyOrObj, value) {
    ...
    } else if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isObject)(keyOrObj)) {
      var obj = keyOrObj;
      var keysArr = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.keys)(obj);
  ...
  Element2.prototype.useState = function(stateName, keepCurrentStates, noAnimation, forceUseHoverLayer) {
    ...
    if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.indexOf)(currentStates, stateName) >= 0 && (keepCurrentStates || currentStates.length === 1)) {
      return;
    }
    var state;
    ...
    if (!state && !toNormalState) {
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.logError)("State " + stateName + " not exists.");
      return;
    }
    if (!toNormalState) {
  ...
  Element2.prototype.removeState = function(state) {
    var idx = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.indexOf)(this.currentStates, state);
    if (idx >= 0) {
  ...
  Element2.prototype.replaceState = function(oldState, newState, forceAdd) {
    var currentStates = this.currentStates.slice();
    var idx = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.indexOf)(currentStates, oldState);
    var newStateExists = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.indexOf)(currentStates, newState) >= 0;
    if (idx >= 0) {
      if (!newStateExists) {
  ...
  Element2.prototype._mergeStates = function(states) {
    ...
    for (var i = 0; i < states.length; i++) {
      var state = states[i];
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)(mergedState, state);
      if (state.textConfig) {
        mergedTextConfig = mergedTextConfig || {};
        (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)(mergedTextConfig, state.textConfig);
      }
    }
    if (mergedTextConfig) {
  ...
  Element2.prototype._applyStateObj = function(stateName, state, normalState, keepCurrentStates, transition, animationCfg) {
    ...
    if (state && state.textConfig) {
      this.textConfig = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)({}, keepCurrentStates ? this.textConfig : normalState.textConfig);
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)(this.textConfig, state.textConfig);
  ...
  Element2.prototype.setTextConfig = function(cfg) {
    ...
    (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)(this.textConfig, cfg);
    this.markRedraw();
  };
  ...
  Element2.prototype.animate = function(key, loop, allowDiscreteAnimation) {
    ...
    if (true) {
      if (!target) {
        (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.logError)('Property "' + key + '" is not existed in element ' + this.id);
        return;
      }
    }
  ...
  Element2.prototype.addAnimator = function(animator, key) {
    ...
    animator.during(function() {
      ...
      var idx = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.indexOf)(animators, animator);
      if (idx >= 0) {
...
(0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.mixin)(Element, _core_Eventful_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
(0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.mixin)(Element, _core_Transformable_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
function is2DArray(value) {
  return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isArrayLike)(value[0]);
}
function copyValue(target, source, key) {
  if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isArrayLike)(source[key])) {
    if (!(0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isArrayLike)(target[key])) {
      target[key] = [];
    }
    if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isTypedArray)(source[key])) {
...
function isValueSame(val1, val2) {
  return val1 === val2 || (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isArrayLike)(val1) && (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isArrayLike)(val2) && is1DArraySame(val1, val2);
}
...
function animateToShallow(animatable, topKey, animateObj, target, cfg, animationProps, animators, reverse) {
  var targetKeys = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.keys)(target);
  var duration = cfg.duration;
  var delay = cfg.delay;
  var additive = cfg.additive;
  var setToFinal = cfg.setToFinal;
  var animateAll = !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isObject)(animationProps);
  ...
  for (var k = 0; k < targetKeys.length; k++) {
    ...
    if (targetVal != null && animateObj[innerKey] != null && (animateAll || animationProps[innerKey])) {
      if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isObject)(targetVal) && !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isArrayLike)(targetVal) && !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isGradientObject)(targetVal)) {
        if (topKey) {
          if (!reverse) {
  ...
  if (!additive && keyLen) {
    for (var i = 0; i < existsAnimators.length; i++) {
      ...
      if (animator.targetName === topKey) {
        ...
        if (allAborted) {
          var idx = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.indexOf)(existsAnimators, animator);
  ...
  if (!cfg.force) {
    animationKeys = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.filter)(animationKeys, function(key) {
  ...
  if (keyLen > 0 || cfg.force && !animators.length) {
    ...
    if (reverse) {
      ...
      for (var i = 0; i < keyLen; i++) {
        var innerKey = animationKeys[i];
        sourceClone[innerKey] = (0,_animation_Animator_js__WEBPACK_IMPORTED_MODULE_1__.cloneValue)(animateObj[innerKey]);
        copyValue(animateObj, target, innerKey);
      }
    }
    var animator = new _animation_Animator_js__WEBPACK_IMPORTED_MODULE_1__["default"](animateObj, false, false, additive ? (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.filter)(existsAnimators, function(animator2) {
...
var EmptyProxy = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(EmptyProxy2, _super);
...
var Handler = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(Handler2, _super);
...
_core_util_js__WEBPACK_IMPORTED_MODULE_1__.each(["click", "mousedown", "mouseup", "mousewheel", "dblclick", "contextmenu"], function(name) {
  Handler.prototype[name] = function(event) {
    ...
    if (name === "mousedown") {
      ...
      if (this._downEl !== this._upEl || !this._downPoint || _core_vector_js__WEBPACK_IMPORTED_MODULE_2__.dist(this._downPoint, [event.zrX, event.zrY]) > 4) {
        return;
      }
...
var Storage = (function() {
  ...
  Storage2.prototype.updateDisplayList = function(includeIgnore) {
    ...
    (0,_core_timsort_js__WEBPACK_IMPORTED_MODULE_1__["default"])(displayList, shapeCompareFunc);
  };
...
function cloneValue(value) {
  if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isArrayLike)(value)) {
    var len = value.length;
    if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isArrayLike)(value[0])) {
      var ret = [];
      for (var i = 0; i < len; i++) {
...
function guessArrayDim(value) {
  return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isArrayLike)(value && value[0]) ? 2 : 1;
}
...
var Track = (function() {
  ...
  Track2.prototype.addKeyframe = function(time, rawValue, easing) {
    ...
    var value = rawValue;
    if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isArrayLike)(rawValue)) {
      var arrayDim = guessArrayDim(rawValue);
      valType = arrayDim;
      if (arrayDim === 1 && !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(rawValue[0]) || arrayDim === 2 && !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(rawValue[0][0])) {
        discrete = true;
      }
    } else {
      if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isNumber)(rawValue) && !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.eqNaN)(rawValue)) {
        valType = VALUE_TYPE_NUMBER;
      } else if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isString)(rawValue)) {
        if (!isNaN(+rawValue)) {
          valType = VALUE_TYPE_NUMBER;
        } else {
      ...
      } else if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isGradientObject)(rawValue)) {
        var parsedGradient = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.extend)({}, value);
        parsedGradient.colorStops = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.map)(rawValue.colorStops, function(colorStop) {
          return {
            offset: colorStop.offset,
            color: _tool_color_js__WEBPACK_IMPORTED_MODULE_1__.parse(colorStop.color)
          };
        });
        if ((0,_svg_helper_js__WEBPACK_IMPORTED_MODULE_5__.isLinearGradient)(rawValue)) {
          valType = VALUE_TYPE_LINEAR_GRADIENT;
        } else if ((0,_svg_helper_js__WEBPACK_IMPORTED_MODULE_5__.isRadialGradient)(rawValue)) {
    ...
    if (easing) {
      kf.easing = easing;
      kf.easingFunc = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.isFunction)(easing) ? easing : _easing_js__WEBPACK_IMPORTED_MODULE_3__["default"][easing] || (0,_cubicEasing_js__WEBPACK_IMPORTED_MODULE_4__.createCubicEasingFunc)(easing);
    }
    keyframes.push(kf);
    return kf;
  };
  ...
  Track2.prototype.step = function(target, percent) {
    ...
    if (this.discrete) {
      ...
      target[propName] = {
        ...
        colorStops: (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.map)(val.colorStops, function(colorStop, idx) {
...
var Animator = (function() {
  function Animator2(target, loop, allowDiscreteAnimation, additiveTo) {
    ...
    this._loop = loop;
    if (loop && additiveTo) {
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.logError)("Can' use additive animation on looped animation.");
      return;
    }
  ...
  Animator2.prototype.when = function(time, props, easing) {
    return this.whenWithKeys(time, props, (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.keys)(props), easing);
  };
  ...
  Animator2.prototype.getTracks = function() {
    var _this = this;
    return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.map)(this._trackKeys, function(key) {
  ...
  Animator2.prototype.__changeFinalValue = function(finalProps, trackKeys) {
    trackKeys = trackKeys || (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.keys)(finalProps);
    for (var i = 0; i < trackKeys.length; i++) {
      var propName = trackKeys[i];
      var track = this._tracks[propName];
      if (!track) {
...
var Clip = (function() {
  ...
  Clip2.prototype.setEasing = function(easing) {
    this.easing = easing;
    this.easingFunc = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.isFunction)(easing) ? easing : _easing_js__WEBPACK_IMPORTED_MODULE_0__["default"][easing] || (0,_cubicEasing_js__WEBPACK_IMPORTED_MODULE_2__.createCubicEasingFunc)(easing);
  };
  return Clip2;
})();
...
function createCubicEasingFunc(cubicEasingStr) {
  ...
  if (cubic) {
    ...
    var a_1 = +(0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.trim)(points[0]);
    var b_1 = +(0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.trim)(points[1]);
    var c_1 = +(0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.trim)(points[2]);
    var d_1 = +(0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.trim)(points[3]);
    if (isNaN(a_1 + b_1 + c_1 + d_1)) {
      return;
    }
    var roots_1 = [];
    return function(p) {
      return p <= 0 ? 0 : p >= 1 ? 1 : (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_0__.cubicRootAt)(0, a_1, c_1, 1, p, roots_1) && (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_0__.cubicAt)(0, b_1, d_1, 1, roots_1[0]);
    };
  }
}
...
var Layer = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(Layer2, _super);
  ...
  Layer2.prototype.createRepaintRects = function(displayList, prevList, viewWidth, viewHeight) {
    ...
    for (var i = this.__startIndex; i < this.__endIndex; ++i) {
      ...
      if (el) {
        ...
        var prevRect = el.__isRendered && (el.__dirty & _graphic_constants_js__WEBPACK_IMPORTED_MODULE_7__.REDRAW_BIT || !shouldPaint) ? el.getPrevPaintRect() : null;
        if (prevRect) {
          addRectToMergePool(prevRect);
        }
        var curRect = shouldPaint && (el.__dirty & _graphic_constants_js__WEBPACK_IMPORTED_MODULE_7__.REDRAW_BIT || !el.__isRendered) ? el.getPaintRect() : null;
        if (curRect) {
    ...
    function doClear(x, y, width2, height2) {
      ...
      if (clearColor && clearColor !== "transparent") {
        ...
        if (_core_util_js__WEBPACK_IMPORTED_MODULE_1__.isGradientObject(clearColor)) {
          ...
          clearColorGradientOrPattern = shouldCache && clearColor.__canvasGradient || (0,_helper_js__WEBPACK_IMPORTED_MODULE_4__.getCanvasGradient)(ctx, clearColor, {
            x: 0,
            y: 0,
            width: width2,
            height: height2
          ...
          clearColorGradientOrPattern = (0,_graphic_js__WEBPACK_IMPORTED_MODULE_5__.createCanvasPattern)(ctx, clearColor, {
            dirty: function() {
              self.setUnpainted();
...
var CanvasPainter = (function() {
  function CanvasPainter2(root, storage, opts, id) {
    ...
    if (!singleCanvas) {
      this._width = (0,_helper_js__WEBPACK_IMPORTED_MODULE_7__.getSize)(root, 0, opts);
      this._height = (0,_helper_js__WEBPACK_IMPORTED_MODULE_7__.getSize)(root, 1, opts);
  ...
  CanvasPainter2.prototype._paintHoverList = function(list) {
    ...
    for (var i = 0; i < len; i++) {
      ...
      if (el.__inHover) {
        ...
        (0,_graphic_js__WEBPACK_IMPORTED_MODULE_5__.brush)(ctx, el, scope, i === len - 1);
      }
    }
    if (ctx) {
      ctx.restore();
  ...
  CanvasPainter2.prototype.paintOne = function(ctx, el) {
    (0,_graphic_js__WEBPACK_IMPORTED_MODULE_5__.brushSingle)(ctx, el);
  };
  CanvasPainter2.prototype._paintList = function(list, prevList, paintAll, redrawId) {
    ...
    if (!finished) {
      var self_1 = this;
      (0,_animation_requestAnimationFrame_js__WEBPACK_IMPORTED_MODULE_3__["default"])(function() {
  ...
  CanvasPainter2.prototype._doPaintList = function(list, prevList, paintAll) {
    ...
    if (_core_env_js__WEBPACK_IMPORTED_MODULE_4__["default"].wxa) {
      _core_util_js__WEBPACK_IMPORTED_MODULE_1__.each(this._layers, function(layer2) {
  ...
  CanvasPainter2.prototype._doPaintEl = function(el, currentLayer, useDirtyRect, repaintRect, scope, isLast) {
    ...
    if (useDirtyRect) {
      ...
      if (!repaintRect || paintRect && paintRect.intersect(repaintRect)) {
        (0,_graphic_js__WEBPACK_IMPORTED_MODULE_5__.brush)(ctx, el, scope, isLast);
  ...
  CanvasPainter2.prototype.resize = function(width, height) {
    if (!this._domRoot.style) {
      ...
      width = (0,_helper_js__WEBPACK_IMPORTED_MODULE_7__.getSize)(root, 0, opts);
      height = (0,_helper_js__WEBPACK_IMPORTED_MODULE_7__.getSize)(root, 1, opts);
...
function createCanvasPattern(ctx, pattern, el) {
  var image = (0,_graphic_helper_image_js__WEBPACK_IMPORTED_MODULE_2__.createOrUpdateImage)(pattern.image, pattern.__image, el);
  if ((0,_graphic_helper_image_js__WEBPACK_IMPORTED_MODULE_2__.isImageReady)(image)) {
...
function brushPath(ctx, el, style, inBatch) {
  ...
  if (ctx.setLineDash && style.lineDash) {
    _a = (0,_dashStyle_js__WEBPACK_IMPORTED_MODULE_8__.getLineDash)(el), lineDash = _a[0], lineDashOffset = _a[1];
  }
...
function brushImage(ctx, el, style) {
  var image = el.__image = (0,_graphic_helper_image_js__WEBPACK_IMPORTED_MODULE_2__.createOrUpdateImage)(style.image, el.__image, el, el.onload);
  if (!image || !(0,_graphic_helper_image_js__WEBPACK_IMPORTED_MODULE_2__.isImageReady)(image)) {
    return;
  }
  var x = style.x || 0;
  var y = style.y || 0;
...
function brush(ctx, el, scope, isLast) {
  ...
  var canBatchPath = el instanceof _graphic_Path_js__WEBPACK_IMPORTED_MODULE_4__["default"] && el.autoBatch && canPathBatch(el.style);
...
function containPath(path, lineWidth, isStroke, x, y) {
  ...
  for (var i = 0; i < len; ) {
    ...
    if (cmd === CMD.M && i > 1) {
      if (!isStroke) {
        w += (0,_windingLine_js__WEBPACK_IMPORTED_MODULE_6__["default"])(xi, yi, x0, y0, x, y);
      }
    }
    if (isFirst) {
      xi = data[i];
    ...
    switch (cmd) {
      ...
      case CMD.L:
        if (isStroke) {
          ...
          w += (0,_windingLine_js__WEBPACK_IMPORTED_MODULE_6__["default"])(xi, yi, data[i], data[i + 1], x, y) || 0;
        }
        xi = data[i++];
        yi = data[i++];
        break;
      ...
      case CMD.A:
        ...
        if (!isFirst) {
          w += (0,_windingLine_js__WEBPACK_IMPORTED_MODULE_6__["default"])(xi, yi, x1, y1, x, y);
        } else {
          x0 = x1;
          y0 = y1;
        }
      ...
      case CMD.R:
        ...
        y1 = y0 + height;
        if (isStroke) {
          if (_line_js__WEBPACK_IMPORTED_MODULE_1__.containStroke(x0, y0, x1, y0, lineWidth, x, y) || _line_js__WEBPACK_IMPORTED_MODULE_1__.containStroke(x1, y0, x1, y1, lineWidth, x, y) || _line_js__WEBPACK_IMPORTED_MODULE_1__.containStroke(x1, y1, x0, y1, lineWidth, x, y) || _line_js__WEBPACK_IMPORTED_MODULE_1__.containStroke(x0, y1, x0, y0, lineWidth, x, y)) {
            return true;
          }
        } else {
          w += (0,_windingLine_js__WEBPACK_IMPORTED_MODULE_6__["default"])(x1, y0, x1, y1, x, y);
          w += (0,_windingLine_js__WEBPACK_IMPORTED_MODULE_6__["default"])(x0, y1, x0, y0, x, y);
        }
        break;
      case CMD.Z:
        if (isStroke) {
  ...
  if (!isStroke && !isAroundEqual(yi, y0)) {
    w += (0,_windingLine_js__WEBPACK_IMPORTED_MODULE_6__["default"])(xi, yi, x0, y0, x, y) || 0;
  }
  return w !== 0;
}
...
/* harmony export */   ensureFontMeasureInfo: () => (/* binding */ ensureFontMeasureInfo),
/* harmony export */   getBoundingRect: () => (/* binding */ getBoundingRect),
/* harmony export */   getLineHeight: () => (/* binding */ getLineHeight),
/* harmony export */   measureCharWidth: () => (/* binding */ measureCharWidth),
/* harmony export */   measureWidth: () => (/* binding */ measureWidth),
/* harmony export */   parsePercent: () => (/* binding */ parsePercent)
/* harmony export */ });
/* unused harmony exports getWidth, innerGetBoundingRect, measureText */
...
function ensureFontMeasureInfo(font) {
  if (!_fontMeasureInfoCache) {
    _fontMeasureInfoCache = new _core_LRU_js__WEBPACK_IMPORTED_MODULE_1__["default"](100);
  }
  ...
  if (!measureInfo) {
    measureInfo = {
      font,
      strWidthCache: new _core_LRU_js__WEBPACK_IMPORTED_MODULE_1__["default"](500),
      asciiWidthMap: null,
      asciiWidthMapTried: false,
      stWideCharWidth: _core_platform_js__WEBPACK_IMPORTED_MODULE_2__.platformApi.measureText("\u56FD", font).width,
      asciiCharWidth: _core_platform_js__WEBPACK_IMPORTED_MODULE_2__.platformApi.measureText("a", font).width
    };
...
function tryCreateASCIIWidthMap(font) {
  ...
  for (var code = 0; code <= 127; code++) {
    asciiWidthMap[code] = _core_platform_js__WEBPACK_IMPORTED_MODULE_2__.platformApi.measureText(String.fromCharCode(code), font).width;
  }
...
function measureWidth(fontMeasureInfo, text) {
  ...
  if (width == null) {
    width = _core_platform_js__WEBPACK_IMPORTED_MODULE_2__.platformApi.measureText(text, fontMeasureInfo.font).width;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createIntersectContext: () => (/* binding */ createIntersectContext),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
...
var BoundingRect = (function() {
  ...
  BoundingRect2.intersect = function(a, b, mtv, opt) {
    ...
    if (useMTV || outIntersectRect) {
      ...
      if (useMTV) {
        _Point_js__WEBPACK_IMPORTED_MODULE_1__["default"].copy(mtv, overlap ? _intersectCtx.useDir ? _intersectCtx.dirMinTv : _minTv : _maxTv);
      }
    }
    return overlap;
  };
...
function createIntersectContext() {
  var _direction = 0;
  var _dirCheckVec = new _Point_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  var _dirTmp = new _Point_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
  var _ctx = {
    minTv: new _Point_js__WEBPACK_IMPORTED_MODULE_1__["default"](),
    maxTv: new _Point_js__WEBPACK_IMPORTED_MODULE_1__["default"](),
    useDir: false,
    dirMinTv: new _Point_js__WEBPACK_IMPORTED_MODULE_1__["default"](),
    touchThreshold: 0,
    bidirectional: true,
    negativeSize: false,
...
var _extent = [0, 0];
var _extent2 = [0, 0];
var _intersectCtx = (0,_BoundingRect_js__WEBPACK_IMPORTED_MODULE_1__.createIntersectContext)();
var _minTv = _intersectCtx.minTv;
var _maxTv = _intersectCtx.maxTv;
var OrientedBoundingRect = (function() {
  ...
  OrientedBoundingRect2.prototype.intersect = function(other, mtv, opt) {
    ...
    if (!noMtv && !_intersectCtx.negativeSize) {
      _Point_js__WEBPACK_IMPORTED_MODULE_0__["default"].copy(mtv, overlapped ? _intersectCtx.useDir ? _intersectCtx.dirMinTv : _minTv : _maxTv);
    }
    return overlapped;
  };
    ...
    for (var i = 0; i < 2; i++) {
      ...
      if (_intersectCtx.negativeSize || _extent[1] < _extent2[0] || _extent[0] > _extent2[1]) {
        ...
        if (mathMin(dist0, dist1) > _maxTv.len()) {
          if (dist0 < dist1) {
            _Point_js__WEBPACK_IMPORTED_MODULE_0__["default"].scale(_maxTv, axis, -dist0 * inverse);
          } else {
            _Point_js__WEBPACK_IMPORTED_MODULE_0__["default"].scale(_maxTv, axis, dist1 * inverse);
          }
        }
      } else if (!noMtv) {
        var dist0 = mathAbs(_extent2[0] - _extent[1]);
        ...
        if (_intersectCtx.useDir || mathMin(dist0, dist1) < _minTv.len()) {
          if (dist0 < dist1 || !_intersectCtx.bidirectional) {
            _Point_js__WEBPACK_IMPORTED_MODULE_0__["default"].scale(_minTv, axis, dist0 * inverse);
            if (_intersectCtx.useDir) {
              _intersectCtx.calcDirMTV();
            }
          }
          if (dist0 >= dist1 || !_intersectCtx.bidirectional) {
            _Point_js__WEBPACK_IMPORTED_MODULE_0__["default"].scale(_minTv, axis, -dist1 * inverse);
            if (_intersectCtx.useDir) {
              _intersectCtx.calcDirMTV();
            }
          }
    ...
    for (i = 0; i < this._len; ) {
      ...
      switch (cmd) {
        case CMD.M:
          ...
          break;
        case CMD.L:
          (0,_bbox_js__WEBPACK_IMPORTED_MODULE_3__.fromLine)(xi, yi, data[i], data[i + 1], min2, max2);
          xi = data[i++];
          yi = data[i++];
          break;
        case CMD.C:
          (0,_bbox_js__WEBPACK_IMPORTED_MODULE_3__.fromCubic)(xi, yi, data[i++], data[i++], data[i++], data[i++], data[i], data[i + 1], min2, max2);
          xi = data[i++];
          yi = data[i++];
          break;
        case CMD.Q:
          (0,_bbox_js__WEBPACK_IMPORTED_MODULE_3__.fromQuadratic)(xi, yi, data[i++], data[i++], data[i], data[i + 1], min2, max2);
          xi = data[i++];
          yi = data[i++];
          break;
        case CMD.A:
          ...
          (0,_bbox_js__WEBPACK_IMPORTED_MODULE_3__.fromArc)(cx, cy, rx, ry, startAngle, endAngle, anticlockwise, min2, max2);
        ...
        case CMD.R:
          ...
          var width = data[i++];
          var height = data[i++];
          (0,_bbox_js__WEBPACK_IMPORTED_MODULE_3__.fromLine)(x0, y0, x0 + width, y0 + height, min2, max2);
          break;
        case CMD.Z:
          xi = x0;
          yi = y0;
...
/* harmony export */   transformLocalCoordClear: () => (/* binding */ transformLocalCoordClear)
/* harmony export */ });
...
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./util.js */ "../../node_modules/zrender/lib/core/util.js");
...
function prepareCoordMarkers(el, saved) {
  ...
  saved.clearMarkers = function() {
    (0,_util_js__WEBPACK_IMPORTED_MODULE_2__.each)(markers, function(marker2) {
...
function normalizeGlobalEvent(instance, event) {
  return (0,_core_event_js__WEBPACK_IMPORTED_MODULE_1__.normalizeEvent)(instance.dom, new FakeGlobalEvent(instance, event), true);
}
...
var localDOMHandlers = {
  mousedown: function(event) {
    event = (0,_core_event_js__WEBPACK_IMPORTED_MODULE_1__.normalizeEvent)(this.dom, event);
...
function mountLocalDOMEventListeners(instance, scope) {
  ...
  if (_core_env_js__WEBPACK_IMPORTED_MODULE_4__["default"].pointerEventsSupported) {
    ...
    _core_util_js__WEBPACK_IMPORTED_MODULE_2__.each(localNativeListenerNames.mouse, function(nativeEventName) {
      mountSingleDOMEventListener(scope, nativeEventName, function(event) {
        event = (0,_core_event_js__WEBPACK_IMPORTED_MODULE_1__.getNativeEvent)(event);
        if (!scope.touching) {
          domHandlers[nativeEventName].call(instance, event);
        }
      });
...
function mountSingleDOMEventListener(scope, nativeEventName, listener, opt) {
  ...
  (0,_core_event_js__WEBPACK_IMPORTED_MODULE_1__.addEventListener)(scope.domTarget, nativeEventName, listener, opt);
}
function unmountDOMEventListeners(scope) {
  var mounted = scope.mounted;
  for (var nativeEventName in mounted) {
    if (mounted.hasOwnProperty(nativeEventName)) {
      (0,_core_event_js__WEBPACK_IMPORTED_MODULE_1__.removeEventListener)(scope.domTarget, nativeEventName, mounted[nativeEventName], scope.listenerOpts[nativeEventName]);
    }
  }
  scope.mounted = {};
}
...
var HandlerDomProxy = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(HandlerDomProxy2, _super);
...
var Displayable = (function(_super) {
  ...
  Displayable2.prototype._init = function(props) {
    var keysArr = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.keys)(props);
    for (var i = 0; i < keysArr.length; i++) {
      var key = keysArr[i];
      if (key === "style") {
  ...
  Displayable2.prototype.setStyle = function(keyOrObj, value) {
    if (typeof keyOrObj === "string") {
      ...
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.extend)(this.style, keyOrObj);
    }
    this.dirtyStyle();
    return this;
  };
  ...
  Displayable2.prototype.createStyle = function(obj) {
    return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.createObject)(DEFAULT_COMMON_STYLE, obj);
  };
    ...
    if (targetStyle) {
      if (transition) {
        ...
        if (needsRestoreToNormal) {
          var changedKeys = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.keys)(sourceStyle);
        ...
        var targetKeys = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.keys)(targetStyle);
  ...
  Displayable2.prototype._mergeStyle = function(targetStyle, sourceStyle) {
    (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.extend)(targetStyle, sourceStyle);
    return targetStyle;
  };
...
var DEFAULT_IMAGE_STYLE = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.defaults)({
  x: 0,
  y: 0
}, _Displayable_js__WEBPACK_IMPORTED_MODULE_1__.DEFAULT_COMMON_STYLE);
var DEFAULT_IMAGE_ANIMATION_PROPS = {
  style: (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.defaults)({
    x: true,
    y: true,
    width: true,
    height: true,
...
var ZRImage = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(ZRImage2, _super);
  function ZRImage2() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  ZRImage2.prototype.createStyle = function(obj) {
    return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.createObject)(DEFAULT_IMAGE_STYLE, obj);
  };
...
var DEFAULT_PATH_STYLE = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.defaults)({
  fill: "#000",
  stroke: null,
  strokePercent: 1,
  fillOpacity: 1,
...
var DEFAULT_PATH_ANIMATION_PROPS = {
  style: (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.defaults)({
    fill: true,
    stroke: true,
    strokePercent: true,
    fillOpacity: true,
...
var pathCopyParams = _core_Transformable_js__WEBPACK_IMPORTED_MODULE_8__.TRANSFORMABLE_PROPS.concat([
  "invisible",
  "culling",
  "z",
  "z2",
...
var Path = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(Path2, _super);
  function Path2(opts) {
  ...
  Path2.prototype._init = function(props) {
    var keysArr = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.keys)(props);
    ...
    for (var i = 0; i < keysArr.length; i++) {
      ...
      if (key === "style") {
        if (!this.style) {
          ...
          (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)(this.style, value);
        }
      } else if (key === "shape") {
        (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)(this.shape, value);
      } else {
        _super.prototype.attrKV.call(this, key, value);
      }
    }
  ...
  Path2.prototype.getInsideTextFill = function() {
    ...
    if (pathFill !== "none") {
      if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.isString)(pathFill)) {
  ...
  Path2.prototype.setShape = function(keyOrObj, value) {
    ...
    if (typeof keyOrObj === "string") {
      ...
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)(shape, keyOrObj);
    }
    this.dirtyShape();
    return this;
  };
  ...
  Path2.prototype.createStyle = function(obj) {
    return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.createObject)(DEFAULT_PATH_STYLE, obj);
  };
  Path2.prototype._innerSaveToNormal = function(toState) {
    _super.prototype._innerSaveToNormal.call(this, toState);
    var normalState = this._normalState;
    if (toState.shape && !normalState.shape) {
      normalState.shape = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)({}, this.shape);
    }
  };
  Path2.prototype._applyStateObj = function(stateName, state, normalState, keepCurrentStates, transition, animationCfg) {
    ...
    if (state && state.shape) {
      if (transition) {
        if (keepCurrentStates) {
          ...
          targetShape = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)({}, normalState.shape);
          (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)(targetShape, state.shape);
        }
      } else {
        targetShape = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)({}, keepCurrentStates ? this.shape : normalState.shape);
        (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)(targetShape, state.shape);
      }
    } else if (needsRestoreToNormal) {
    ...
    if (targetShape) {
      if (transition) {
        this.shape = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)({}, this.shape);
        var targetShapePrimaryProps = {};
        var shapeKeys = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.keys)(targetShape);
  ...
  Path2.extend = function(defaultProps) {
    var Sub = (function(_super2) {
      (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(Sub2, _super2);
      function Sub2(opts) {
      ...
      Sub2.prototype.getDefaultStyle = function() {
        return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.clone)(defaultProps.style);
      };
      Sub2.prototype.getDefaultShape = function() {
        return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.clone)(defaultProps.shape);
      };
      return Sub2;
    })(Path2);
...
var DEFAULT_TSPAN_STYLE = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.defaults)({
  strokeFirst: true,
  font: _core_platform_js__WEBPACK_IMPORTED_MODULE_4__.DEFAULT_FONT,
  x: 0,
  y: 0,
  textAlign: "left",
  textBaseline: "top",
...
var TSpan = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(TSpan2, _super);
  function TSpan2() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
  ...
  TSpan2.prototype.createStyle = function(obj) {
    return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.createObject)(DEFAULT_TSPAN_STYLE, obj);
  };
...
var ZRText = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(ZRText2, _super);
  ...
  ZRText2.prototype._mergeRich = function(targetRich, sourceRich) {
    var richNames = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.keys)(sourceRich);
    for (var i = 0; i < richNames.length; i++) {
      var richName = richNames[i];
      targetRich[richName] = targetRich[richName] || {};
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.extend)(targetRich[richName], sourceRich[richName]);
    }
  };
  ...
  ZRText2.prototype._updatePlainTexts = function() {
    ...
    (0,_helper_parseText_js__WEBPACK_IMPORTED_MODULE_1__.calcInnerTextOverflowArea)(tmpCITOverflowAreaOut, defaultStyle.overflowRect, baseX, baseY, textAlign, verticalAlign);
    baseX = tmpCITOverflowAreaOut.baseX;
    baseY = tmpCITOverflowAreaOut.baseY;
    var text = getStyleText(style);
    var contentBlock = (0,_helper_parseText_js__WEBPACK_IMPORTED_MODULE_1__.parsePlainText)(text, style, tmpCITOverflowAreaOut.outerWidth, tmpCITOverflowAreaOut.outerHeight);
    ...
    var textX = baseX;
    var textY = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextY)(baseY, contentBlock.contentHeight, verticalAlign);
    if (needDrawBg || textPadding) {
      var boxX = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextX)(baseX, outerWidth, textAlign);
      var boxY = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_4__.adjustTextY)(baseY, outerHeight, verticalAlign);
    ...
    for (var i = 0; i < textLines.length; i++) {
      ...
      textY += lineHeight;
      el.setBoundingRect((0,_helper_parseText_js__WEBPACK_IMPORTED_MODULE_1__.tSpanCreateBoundingRect2)(subElStyle, contentBlock.contentWidth, contentBlock.calculatedLineHeight, usingDefaultStroke ? 0 : null));
    }
  };
  ZRText2.prototype._updateRichTexts = function() {
    ...
    baseY = tmpCITOverflowAreaOut.baseY;
    var text = getStyleText(style);
    var contentBlock = (0,_helper_parseText_js__WEBPACK_IMPORTED_MODULE_1__.parseRichText)(text, style, tmpCITOverflowAreaOut.outerWidth, tmpCITOverflowAreaOut.outerHeight, textAlign);
  ...
  ZRText2.prototype._placeToken = function(token, style, lineHeight, lineTop, x, textAlign, parentBgColorDrawn) {
    ...
    subElStyle.opacity = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve3)(tokenStyle.opacity, style.opacity, 1);
    setSeparateFont(subElStyle, tokenStyle);
    if (textStroke) {
      subElStyle.lineWidth = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve3)(tokenStyle.lineWidth, style.lineWidth, defaultLineWidth);
      subElStyle.lineDash = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve2)(tokenStyle.lineDash, style.lineDash);
      subElStyle.lineDashOffset = style.lineDashOffset || 0;
      subElStyle.stroke = textStroke;
    }
    if (textFill) {
    ...
    el.setBoundingRect((0,_helper_parseText_js__WEBPACK_IMPORTED_MODULE_1__.tSpanCreateBoundingRect2)(subElStyle, token.contentWidth, token.contentHeight, usingDefaultStroke ? 0 : null));
  };
  ZRText2.prototype._renderBackground = function(style, topStyle, x, y, width, height) {
    ...
    if (isPlainOrGradientBg) {
      ...
      rectStyle.fillOpacity = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve2)(style.fillOpacity, 1);
    } else if (isImageBg) {
    ...
    if (textBorderWidth && textBorderColor) {
      ...
      rectStyle.strokeOpacity = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve2)(style.strokeOpacity, 1);
    ...
    commonStyle.opacity = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve3)(style.opacity, topStyle.opacity, 1);
  };
  ZRText2.makeFont = function(style) {
    ...
    return font && (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.trim)(font) || style.textFont || style.font;
  };
  return ZRText2;
...
function normalizeTextStyle(style) {
  ...
  (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.each)(style.rich, normalizeStyle);
  return style;
}
function normalizeStyle(style) {
  if (style) {
    ...
    var textPadding = style.padding;
    if (textPadding) {
      style.padding = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.normalizeCssArray)(style.padding);
    }
  }
}
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   calcInnerTextOverflowArea: () => (/* binding */ calcInnerTextOverflowArea),
/* harmony export */   parsePlainText: () => (/* binding */ parsePlainText),
/* harmony export */   parseRichText: () => (/* binding */ parseRichText),
/* harmony export */   tSpanCreateBoundingRect: () => (/* binding */ tSpanCreateBoundingRect),
/* harmony export */   tSpanCreateBoundingRect2: () => (/* binding */ tSpanCreateBoundingRect2),
/* harmony export */   tSpanHasStroke: () => (/* binding */ tSpanHasStroke),
...
function prepareTruncateOptions(containerWidth, font, ellipsis, options) {
  options = options || {};
  var preparedOpts = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.extend)({}, options);
  ellipsis = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(ellipsis, "...");
  preparedOpts.maxIterations = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(options.maxIterations, 2);
  var minChar = preparedOpts.minChar = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(options.minChar, 0);
  var fontMeasureInfo = preparedOpts.fontMeasureInfo = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.ensureFontMeasureInfo)(font);
  var ascCharWidth = fontMeasureInfo.asciiCharWidth;
  preparedOpts.placeholder = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(options.placeholder, "");
  var contentWidth = containerWidth = Math.max(0, containerWidth - 1);
  for (var i = 0; i < minChar && contentWidth >= ascCharWidth; i++) {
    contentWidth -= ascCharWidth;
  }
  var ellipsisWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)(fontMeasureInfo, ellipsis);
...
function truncateSingleLine(out, textLine, options) {
  ...
  var lineWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)(fontMeasureInfo, textLine);
  ...
  for (var j = 0; ; j++) {
    ...
    lineWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)(fontMeasureInfo, textLine);
  }
  if (textLine === "") {
...
function estimateLength(text, contentWidth, fontMeasureInfo) {
  ...
  for (var len = text.length; i < len && width < contentWidth; i++) {
    width += (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureCharWidth)(fontMeasureInfo, text.charCodeAt(i));
  }
  return i;
}
function parsePlainText(rawText, style, defaultOuterWidth, defaultOuterHeight) {
  ...
  var calculatedLineHeight = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getLineHeight)(font);
  var lineHeight = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(style.lineHeight, calculatedLineHeight);
  ...
  var contentWidth = 0;
  var fontMeasureInfo = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.ensureFontMeasureInfo)(font);
  for (var i = 0; i < lines.length; i++) {
    contentWidth = Math.max((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)(fontMeasureInfo, lines[i]), contentWidth);
  }
  if (width == null) {
    width = contentWidth;
  }
...
function parseRichText(rawText, style, defaultOuterWidth, defaultOuterHeight, topTextAlign) {
  ...
  outer: for (var i = 0; i < contentBlock.lines.length; i++) {
    ...
    for (var j = 0; j < line.tokens.length; j++) {
      ...
      token.contentHeight = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getLineHeight)(font);
      var tokenHeight = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(tokenStyle.height, token.contentHeight);
      token.innerHeight = tokenHeight;
      textPadding && (tokenHeight += textPadding[0] + textPadding[2]);
      token.height = tokenHeight;
      token.lineHeight = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve3)(tokenStyle.lineHeight, style.lineHeight, tokenHeight);
      ...
      if (typeof styleTokenWidth === "string" && styleTokenWidth.charAt(styleTokenWidth.length - 1) === "%") {
        ...
        token.contentWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.ensureFontMeasureInfo)(font), token.text);
      } else {
        ...
        if (remainTruncWidth != null && remainTruncWidth < token.width) {
          if (!tokenWidthNotSpecified || remainTruncWidth < paddingH) {
            ...
            token.width = token.contentWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.ensureFontMeasureInfo)(font), token.text);
          }
        } else {
          token.contentWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.ensureFontMeasureInfo)(font), token.text);
        }
  ...
  contentBlock.outerWidth = contentBlock.width = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(topWidth, calculatedWidth);
  contentBlock.outerHeight = contentBlock.height = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.retrieve2)(topHeight, calculatedHeight);
...
function pushTokens(block, str, style, wrapInfo, styleName) {
  ...
  if (wrapInfo) {
    ...
    if (tokenStyle.width != null && tokenStyle.width !== "auto") {
      var outerWidth_1 = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.parsePercent)(tokenStyle.width, wrapInfo.width) + tokenPaddingH;
      if (lines.length > 0) {
  ...
  for (var i = 0; i < strLines.length; i++) {
    ...
    if (typeof tokenStyle.width === "number") {
      ...
      token.width = linesWidths ? linesWidths[i] : (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)(fontMeasureInfo, text);
    }
    if (!i && !newLine) {
...
var breakCharMap = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_1__.reduce)(",&?/;] ".split(""), function(obj, ch) {
  obj[ch] = true;
  return obj;
}, {});
...
function wrapText(text, font, lineWidth, isBreakAll, lastAccumWidth) {
  ...
  for (var i = 0; i < text.length; i++) {
    ...
    var chWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureCharWidth)(fontMeasureInfo, ch.charCodeAt(0));
...
function calcInnerTextOverflowArea(out, overflowRect, baseX, baseY, textAlign, textVerticalAlign) {
  ...
  _core_BoundingRect_js__WEBPACK_IMPORTED_MODULE_3__["default"].set(tmpCITCTextRect, (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.adjustTextX)(baseX, textWidth, textAlign), (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.adjustTextY)(baseY, textHeight, textVerticalAlign), textWidth, textHeight);
  ...
  out.baseX = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.adjustTextX)(outIntersectRect.x, outIntersectRect.width, textAlign, true);
  out.baseY = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.adjustTextY)(outIntersectRect.y, outIntersectRect.height, textVerticalAlign, true);
}
...
function tSpanCreateBoundingRect(style) {
  ...
  var font = style.font;
  var contentWidth = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.measureWidth)((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.ensureFontMeasureInfo)(font), text);
  var contentHeight = (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.getLineHeight)(font);
...
function tSpanCreateBoundingRect2(style, contentWidth, contentHeight, forceLineWidth) {
  var rect = new _core_BoundingRect_js__WEBPACK_IMPORTED_MODULE_3__["default"]((0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.adjustTextX)(style.x || 0, contentWidth, style.textAlign), (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_2__.adjustTextY)(style.y || 0, contentHeight, style.textBaseline), contentWidth, contentHeight);
...
var BezierCurve = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(BezierCurve2, _super);
  ...
  BezierCurve2.prototype.buildPath = function(ctx, shape) {
    ...
    if (cpx2 == null || cpy2 == null) {
      if (percent < 1) {
        (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_3__.quadraticSubdivide)(x1, cpx1, x2, percent, out);
        cpx1 = out[1];
        x2 = out[2];
        (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_3__.quadraticSubdivide)(y1, cpy1, y2, percent, out);
        cpy1 = out[1];
        y2 = out[2];
      }
      ...
      if (percent < 1) {
        (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_3__.cubicSubdivide)(x1, cpx1, cpx2, x2, percent, out);
        cpx1 = out[1];
        cpx2 = out[2];
        x2 = out[3];
        (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_3__.cubicSubdivide)(y1, cpy1, cpy2, y2, percent, out);
        cpy1 = out[1];
        cpy2 = out[2];
        y2 = out[3];
      }
...
var Rect = (function(_super) {
  ...
  Rect2.prototype.buildPath = function(ctx, shape) {
    ...
    var height;
    if (this.subPixelOptimize) {
      var optimizedShape = (0,_helper_subPixelOptimize_js__WEBPACK_IMPORTED_MODULE_3__.subPixelOptimizeRect)(subPixelOptimizeOutputShape, shape, this.style);
      x = optimizedShape.x;
      y = optimizedShape.y;
...
var SVGPainter = (function() {
  function SVGPainter2(root, storage, opts) {
    ...
    this.storage = storage;
    this._opts = opts = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.extend)({}, opts);
    this.root = root;
    this._id = "zr" + svgId++;
    ...
    if (root && !opts.ssr) {
      ...
      (0,_patch_js__WEBPACK_IMPORTED_MODULE_4__.updateAttrs)(null, this._oldVNode);
  ...
  SVGPainter2.prototype.refresh = function() {
    if (this.root) {
      ...
      (0,_patch_js__WEBPACK_IMPORTED_MODULE_4__["default"])(this._oldVNode, vnode);
      this._oldVNode = vnode;
    }
  };
  SVGPainter2.prototype.renderOneToVNode = function(el) {
    return (0,_graphic_js__WEBPACK_IMPORTED_MODULE_0__.brush)(el, (0,_core_js__WEBPACK_IMPORTED_MODULE_1__.createBrushScope)(this._id));
  };
  SVGPainter2.prototype.renderToVNode = function(opts) {
    ...
    var defs = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.map)((0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.keys)(scope.defs), function(id) {
  ...
  SVGPainter2.prototype.renderToString = function(opts) {
    ...
    return (0,_core_js__WEBPACK_IMPORTED_MODULE_1__.vNodeToString)(this.renderToVNode({
      animation: (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve2)(opts.cssAnimation, true),
      emphasis: (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve2)(opts.cssEmphasis, true),
      willUpdate: false,
      compress: true,
      useViewBox: (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.retrieve2)(opts.useViewBox, true)
    }), { newline: true });
  };
    ...
    for (var i = 0; i < listLen; i++) {
      ...
      if (!displayable.invisible) {
        ...
        for (var i_2 = lca + 1; i_2 < len; i_2++) {
          var groupAttrs = {};
          (0,_graphic_js__WEBPACK_IMPORTED_MODULE_0__.setClipPath)(clipPaths[i_2], groupAttrs, scope);
        ...
        var ret = (0,_graphic_js__WEBPACK_IMPORTED_MODULE_0__.brush)(displayable, scope);
        if (ret) {
  ...
  SVGPainter2.prototype.resize = function(width, height) {
    ...
    if (root && viewport) {
      ...
      width = (0,_canvas_helper_js__WEBPACK_IMPORTED_MODULE_5__.getSize)(root, 0, opts);
      height = (0,_canvas_helper_js__WEBPACK_IMPORTED_MODULE_5__.getSize)(root, 1, opts);
    ...
    if (this._width !== width || this._height !== height) {
      ...
      if (!(0,_helper_js__WEBPACK_IMPORTED_MODULE_2__.isPattern)(this._backgroundColor)) {
  ...
  SVGPainter2.prototype.toDataURL = function(base64) {
    ...
    if (base64) {
      str = (0,_helper_js__WEBPACK_IMPORTED_MODULE_2__.encodeBase64)(str);
...
function createMethodNotSupport(method) {
  return function() {
    if (true) {
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.logError)('In SVG mode painter not support method "' + method + '"');
    }
  };
}
function createBackgroundVNode(width, height, backgroundColor, scope) {
  ...
  if (backgroundColor && backgroundColor !== "none") {
    ...
    if ((0,_helper_js__WEBPACK_IMPORTED_MODULE_2__.isGradient)(backgroundColor)) {
      (0,_graphic_js__WEBPACK_IMPORTED_MODULE_0__.setGradient)({ fill: backgroundColor }, bgVNode.attrs, "fill", scope);
    } else if ((0,_helper_js__WEBPACK_IMPORTED_MODULE_2__.isPattern)(backgroundColor)) {
      (0,_graphic_js__WEBPACK_IMPORTED_MODULE_0__.setPattern)({
        style: {
      ...
      var _a = (0,_helper_js__WEBPACK_IMPORTED_MODULE_2__.normalizeColor)(backgroundColor), color = _a.color, opacity = _a.opacity;
...
function vNodeToString(el, opts) {
  ...
  function convertElToString(el2) {
    ...
    return createElementOpen(tag, attrs) + (tag !== "style" ? (0,_core_dom_js__WEBPACK_IMPORTED_MODULE_1__.encodeHTML)(text) : text || "") + (children ? "" + S + (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.map)(children, function(child) {
...
function getCssString(selectorNodes, animationNodes, opts) {
  ...
  var bracketBegin = " {" + S;
  var bracketEnd = S + "}";
  var selectors = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.map)((0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.keys)(selectorNodes), function(className) {
    return className + bracketBegin + (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.map)((0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.keys)(selectorNodes[className]), function(attrName) {
      return attrName + ":" + selectorNodes[className][attrName] + ";";
    }).join(S) + bracketEnd;
  }).join(S);
  var animations = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.map)((0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.keys)(animationNodes), function(animationName) {
    return "@keyframes " + animationName + bracketBegin + (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.map)((0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.keys)(animationNodes[animationName]), function(percent) {
      return percent + bracketBegin + (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.map)((0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.keys)(animationNodes[animationName][percent]), function(attrName) {
...
function buildPathString(el, kfShape, path) {
  var shape = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)({}, el.shape);
  (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)(shape, kfShape);
  el.buildPath(path, shape);
  var svgPathBuilder = new _SVGPathRebuilder_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  svgPathBuilder.reset((0,_helper_js__WEBPACK_IMPORTED_MODULE_4__.getPathPrecision)(el));
...
function createCompoundPathCSSAnimation(el, attrs, scope) {
  ...
  (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.each)(paths, function(path) {
    var subScope = (0,_core_js__WEBPACK_IMPORTED_MODULE_1__.createBrushScope)(scope.zrId);
    subScope.animation = true;
    createCSSAnimation(path, {}, subScope, true);
    var cssAnims = subScope.cssAnims;
    var cssNodes = subScope.cssNodes;
    var animNames = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.keys)(cssAnims);
...
function getEasingFunc(easing) {
  return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isString)(easing) ? EASING_MAP[easing] ? "cubic-bezier(" + EASING_MAP[easing] + ")" : (0,_animation_cubicEasing_js__WEBPACK_IMPORTED_MODULE_7__.createCubicEasingFunc)(easing) ? easing : "" : "";
}
function createCSSAnimation(el, attrs, scope, onlyShape) {
  ...
  function createSingleCSSAnimation(groupAnimator) {
        ...
        if (track.needsAnimate()) {
          ...
          if (attrName) {
            for (var i3 = 0; i3 < kfs.length; i3++) {
              ...
              if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isString)(rawValue) || (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.isNumber)(rawValue)) {
    ...
    for (var percent in transformKfs) {
      var transform = {};
      (0,_core_Transformable_js__WEBPACK_IMPORTED_MODULE_0__.copyTransform)(transform, el);
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.extend)(transform, transformKfs[percent]);
      var str = (0,_helper_js__WEBPACK_IMPORTED_MODULE_4__.getSRTTransformString)(transform);
    ...
    var percents = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.keys)(finalKfs);
    ...
    if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.filter)(percents, function(percent2) {
      return (0,_core_util_js__WEBPACK_IMPORTED_MODULE_5__.keys)(finalKfs[percent2]).length > 0;
    }).length) {
...
function isImageLike(val) {
  return val && (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.isString)(val.src);
}
function isCanvasLike(val) {
  return val && (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.isFunction)(val.toDataURL);
}
function setStyleAttrs(attrs, style, el, scope) {
  (0,_mapStyleToAttrs_js__WEBPACK_IMPORTED_MODULE_6__["default"])(function(key, val) {
    var isFillStroke = key === "fill" || key === "stroke";
    if (isFillStroke && (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isGradient)(val)) {
      setGradient(style, attrs, key, scope);
    } else if (isFillStroke && (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isPattern)(val)) {
...
function setMetaData(attrs, el) {
  var metaData = (0,_zrender_js__WEBPACK_IMPORTED_MODULE_14__.getElementSSRData)(el);
  if (metaData) {
...
function noRotateScale(m) {
  return (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isAroundZero)(m[0] - 1) && (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isAroundZero)(m[1]) && (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isAroundZero)(m[2]) && (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isAroundZero)(m[3] - 1);
}
function noTranslate(m) {
  return (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isAroundZero)(m[4]) && (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isAroundZero)(m[5]);
}
function setTransform(attrs, m, compress) {
  if (m && !(noTranslate(m) && noRotateScale(m))) {
    var mul = compress ? 10 : 1e4;
    attrs.transform = noRotateScale(m) ? "translate(" + round(m[4] * mul) / mul + " " + round(m[5] * mul) / mul + ")" : (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getMatrixStr)(m);
  }
}
...
function createAttrsConvert(desc) {
  var normalizedDesc = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.map)(desc, function(item) {
...
function brushSVGPath(el, scope) {
  ...
  var precision = scope.compress && (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getPathPrecision)(el) || 4;
  ...
  scope.animation && (0,_cssAnimation_js__WEBPACK_IMPORTED_MODULE_10__.createCSSAnimation)(el, attrs, scope);
  scope.emphasis && (0,_cssEmphasis_js__WEBPACK_IMPORTED_MODULE_13__.createCSSEmphasis)(el, attrs, scope);
  return (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)(svgElType, el.id + "", attrs);
}
function brushSVGImage(el, scope) {
  var style = el.style;
  var image = style.image;
  if (image && !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.isString)(image)) {
  ...
  setMetaData(attrs, el);
  scope.animation && (0,_cssAnimation_js__WEBPACK_IMPORTED_MODULE_10__.createCSSAnimation)(el, attrs, scope);
  return (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("image", el.id + "", attrs);
}
;
function brushSVGTSpan(el, scope) {
  ...
  var x = style.x || 0;
  var y = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.adjustTextY)(style.y || 0, (0,_contain_text_js__WEBPACK_IMPORTED_MODULE_3__.getLineHeight)(font), style.textBaseline);
  var textAlign = _helper_js__WEBPACK_IMPORTED_MODULE_0__.TEXT_ALIGN_TO_ANCHOR[style.textAlign] || style.textAlign;
  var attrs = {
    "dominant-baseline": "central",
    "text-anchor": textAlign
  };
  if ((0,_graphic_Text_js__WEBPACK_IMPORTED_MODULE_11__.hasSeparateFont)(style)) {
    var separatedFontStr = "";
    var fontStyle = style.fontStyle;
    var fontSize = (0,_graphic_Text_js__WEBPACK_IMPORTED_MODULE_11__.parseFontSize)(style.fontSize);
  ...
  setMetaData(attrs, el);
  scope.animation && (0,_cssAnimation_js__WEBPACK_IMPORTED_MODULE_10__.createCSSAnimation)(el, attrs, scope);
  return (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("text", el.id + "", attrs, void 0, text);
}
...
function setShadow(el, attrs, scope) {
  var style = el.style;
  if ((0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.hasShadow)(style)) {
    var shadowKey = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getShadowKey)(el);
    ...
    if (!shadowId) {
      ...
      var _a = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.normalizeColor)(style.shadowColor), opacity = _a.opacity, color = _a.color;
      var stdDx = blur_1 / 2 / scaleX;
      var stdDy = blur_1 / 2 / scaleY;
      var stdDeviation = stdDx + " " + stdDy;
      shadowId = scope.zrId + "-s" + scope.shadowIdx++;
      scope.defs[shadowId] = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("filter", shadowId, {
        "id": shadowId,
        "x": "-100%",
        "y": "-100%",
        "width": "300%",
        ...
        (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("feDropShadow", "", {
          "dx": offsetX / scaleX,
          "dy": offsetY / scaleY,
    ...
    attrs.filter = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getIdURL)(shadowId);
  }
}
function setGradient(style, attrs, target, scope) {
  ...
  if ((0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isLinearGradient)(val)) {
    gradientTag = "linearGradient";
    gradientAttrs.x1 = val.x;
    gradientAttrs.y1 = val.y;
    gradientAttrs.x2 = val.x2;
    gradientAttrs.y2 = val.y2;
  } else if ((0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isRadialGradient)(val)) {
    gradientTag = "radialGradient";
    gradientAttrs.cx = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.retrieve2)(val.x, 0.5);
    gradientAttrs.cy = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.retrieve2)(val.y, 0.5);
    gradientAttrs.r = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.retrieve2)(val.r, 0.5);
  } else {
    if (true) {
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.logError)("Illegal gradient type.");
    }
    return;
  }
  ...
  for (var i = 0, len = colors.length; i < len; ++i) {
    var offset = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.round4)(colors[i].offset) * 100 + "%";
    var stopColor = colors[i].color;
    var _a = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.normalizeColor)(stopColor), color = _a.color, opacity = _a.opacity;
    var stopsAttrs = {
      "offset": offset
    };
    ...
    colorStops.push((0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("stop", i + "", stopsAttrs));
  }
  var gradientVNode = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)(gradientTag, "", gradientAttrs, colorStops);
  var gradientKey = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.vNodeToString)(gradientVNode);
  ...
  if (!gradientId) {
    ...
    scope.defs[gradientId] = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)(gradientTag, gradientId, gradientAttrs, colorStops);
  }
  attrs[target] = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getIdURL)(gradientId);
}
function setPattern(el, attrs, target, scope) {
  ...
  var child;
  if ((0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.isImagePattern)(val)) {
    var imageWidth_1 = val.imageWidth;
    var imageHeight_1 = val.imageHeight;
    var imageSrc = void 0;
    var patternImage = val.image;
    if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.isString)(patternImage)) {
    ...
    if (typeof Image === "undefined") {
      ...
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.assert)(imageWidth_1, errMsg);
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.assert)(imageHeight_1, errMsg);
      ...
      var createdImage = (0,_graphic_helper_image_js__WEBPACK_IMPORTED_MODULE_9__.createOrUpdateImage)(imageSrc, null, el, function(img) {
    ...
    child = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("image", "img", {
      href: imageSrc,
      width: imageWidth_1,
    ...
    child = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_8__.clone)(val.svgElement);
  ...
  var patternTransform = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getSRTTransformString)(val);
  patternTransform && (patternAttrs.patternTransform = patternTransform);
  var patternVNode = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("pattern", "", patternAttrs, [child]);
  var patternKey = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.vNodeToString)(patternVNode);
  ...
  if (!patternId) {
    ...
    patternVNode = scope.defs[patternId] = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("pattern", patternId, patternAttrs, [child]);
  }
  attrs[target] = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getIdURL)(patternId);
}
function setClipPath(clipPath, attrs, scope) {
  ...
  if (!clipPathId) {
    ...
    defs[clipPathId] = (0,_core_js__WEBPACK_IMPORTED_MODULE_7__.createVNode)("clipPath", clipPathId, clipPathAttrs, [brushSVGPath(clipPath, scope)]);
  }
  attrs["clip-path"] = (0,_helper_js__WEBPACK_IMPORTED_MODULE_0__.getIdURL)(clipPathId);
}
...
function normalizeColor(color) {
  ...
  if (!color || color === "transparent") {
    ...
    var arr = (0,_tool_color_js__WEBPACK_IMPORTED_MODULE_1__.parse)(color);
    if (arr) {
...
function getSRTTransformString(transform) {
  ...
  var scaleX = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.retrieve2)(transform.scaleX, 1);
  var scaleY = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.retrieve2)(transform.scaleY, 1);
...
var encodeBase64 = (function() {
  if (_core_env_js__WEBPACK_IMPORTED_MODULE_2__["default"].hasGlobalWindow && (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.isFunction)(window.btoa)) {
    return function(str) {
  ...
  return function(str) {
    if (true) {
      (0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.logError)("Base64 isn't natively supported in the current environment.");
    }
    return null;
  };
})();
...
var svgStrokeProps = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.map)(strokeProps, function(prop) {
...
function mapStyleToAttrs(updateAttr, style, el, forceUpdate) {
  ...
  if (pathHasFill(style)) {
    var fill = (0,_helper_js__WEBPACK_IMPORTED_MODULE_4__.normalizeColor)(style.fill);
  ...
  if (pathHasStroke(style)) {
    var stroke = (0,_helper_js__WEBPACK_IMPORTED_MODULE_4__.normalizeColor)(style.stroke);
    ...
    if (style.lineDash) {
      var _a = (0,_canvas_dashStyle_js__WEBPACK_IMPORTED_MODULE_2__.getLineDash)(el), lineDash = _a[0], lineDashOffset = _a[1];
      if (lineDash) {
...
var colonChar = 58;
var xChar = 120;
var emptyNode = (0,_core_js__WEBPACK_IMPORTED_MODULE_1__.createVNode)("", "");
function isUndef(s) {
  return s === void 0;
}
function isDef(s) {
...
function createElm(vnode) {
  ...
  var tag = vnode.tag;
  if (isDef(tag)) {
    var elm = vnode.elm = (0,_core_js__WEBPACK_IMPORTED_MODULE_1__.createElement)(tag);
    updateAttrs(emptyNode, vnode);
    if ((0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.isArray)(children)) {
    ...
    } else if (isDef(vnode.text) && !(0,_core_util_js__WEBPACK_IMPORTED_MODULE_0__.isObject)(vnode.text)) {
...
/* harmony export */   parseCssFloat: () => (/* binding */ parseCssFloat),
/* harmony export */   parseCssInt: () => (/* binding */ parseCssInt),
...
function adpativeBezier(x0, y0, x1, y1, x2, y2, x3, y3, out, scale) {
  ...
  var tmpSegX = [];
  var tmpSegY = [];
  (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_0__.cubicSubdivide)(x0, x1, x2, x3, 0.5, tmpSegX);
  (0,_core_curve_js__WEBPACK_IMPORTED_MODULE_0__.cubicSubdivide)(y0, y1, y2, y3, 0.5, tmpSegY);
...
function binaryDividePolygon(polygonShape) {
  ...
  var min = [];
  var max = [];
  (0,_core_bbox_js__WEBPACK_IMPORTED_MODULE_0__.fromPoints)(points, min, max);
...
function clone(path, count) {
  ...
  for (var i = 0; i < count; i++) {
    paths.push((0,_path_js__WEBPACK_IMPORTED_MODULE_8__.clonePath)(path));
  }
  return paths;
}
...
function split(path, count) {
  ...
  switch (path.type) {
    ...
    default:
      ...
      var polygons = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.map)((0,_convertPath_js__WEBPACK_IMPORTED_MODULE_7__.pathToPolygons)(path.getUpdatedPathProxy(), scale), function(poly) {
      ...
      if (polygonCount === 0) {
        ...
        var totalArea_1 = 0;
        var items = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_3__.map)(polygons, function(poly) {
          var min = [];
          var max = [];
          (0,_core_bbox_js__WEBPACK_IMPORTED_MODULE_0__.fromPoints)(poly, min, max);
...
function prepareMorphPath(fromPath, toPath) {
  ...
  var _a = alignBezierCurves((0,_convertPath_js__WEBPACK_IMPORTED_MODULE_7__.pathToBezierCurves)(fromPathProxy), (0,_convertPath_js__WEBPACK_IMPORTED_MODULE_7__.pathToBezierCurves)(toPathProxy)), fromBezierCurves = _a[0], toBezierCurves = _a[1];
  ...
  saveAndModifyMethod(toPath, "buildPath", { replace: function(path) {
    ...
    for (var i = 0; i < morphingData.length; i++) {
      ...
      var sa = Math.sin(angle);
      var ca = Math.cos(angle);
      (0,_core_vector_js__WEBPACK_IMPORTED_MODULE_3__.lerp)(newCp, fromCp, toCp, t);
...
function morphPath(fromPath, toPath, animationOpts) {
  ...
  toPath.animateTo({
    __morphT: 1
  }, (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.defaults)({
    during: function(p) {
      toPath.dirtyShape();
...
function sortPaths(pathList) {
  ...
  var xMax = -Infinity;
  var yMax = -Infinity;
  var cps = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.map)(pathList, function(path) {
  ...
  var items = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.map)(cps, function(cp, idx) {
    return {
      cp,
...
function defaultDividePath(param) {
  return (0,_dividePath_js__WEBPACK_IMPORTED_MODULE_6__.split)(param.path, param.count);
}
...
function combineMorph(fromList, toPath, animationOpts) {
  ...
  function addFromPath(fromList2) {
    for (var i2 = 0; i2 < fromList2.length; i2++) {
      ...
      } else if (from2 instanceof _graphic_Path_js__WEBPACK_IMPORTED_MODULE_1__["default"]) {
  ...
  if (individualDelay) {
    ...
    for (var i = 0; i < toLen; i++) {
      var indivdualAnimationOpts = individualDelay ? (0,_core_util_js__WEBPACK_IMPORTED_MODULE_2__.defaults)({
  ...
  if (isCombineMorphing(fromPath)) {
    ...
    if (fromLen < toLen) {
      ...
      for (var i = fromLen; i < toLen; i++) {
        fromPathList.push((0,_path_js__WEBPACK_IMPORTED_MODULE_4__.clonePath)(fromPathList[k++ % fromLen]));
      }
    }
...
/* harmony import */ var _color_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./color.js */ "../../node_modules/zrender/lib/tool/color.js");
...
var INHERITABLE_STYLE_ATTRIBUTES_MAP_KEYS = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.keys)(INHERITABLE_STYLE_ATTRIBUTES_MAP);
var SELF_STYLE_ATTRIBUTES_MAP = {
  "alignment-baseline": "textBaseline",
  "stop-color": "stopColor"
};
var SELF_STYLE_ATTRIBUTES_MAP_KEYS = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.keys)(SELF_STYLE_ATTRIBUTES_MAP);
var SVGParser = (function() {
  ...
  SVGParser2.prototype.parse = function(xml, opt) {
    opt = opt || {};
    var svg = (0,_parseXML_js__WEBPACK_IMPORTED_MODULE_14__.parseXML)(xml);
    if (true) {
      if (!svg) {
  ...
  SVGParser2.prototype._parseNode = function(xmlNode, parentGroup, named, namedFrom, isInDefs, isInText) {
    ...
    if (nodeName === "defs" || nodeName === "switch") {
      ...
      if (!isInDefs) {
        ...
        if (parser_1 && (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.hasOwn)(nodeParsers, nodeName)) {
      ...
      if (parser && (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.hasOwn)(paintServerParsers, nodeName)) {
  ...
  SVGParser2.internalField = (function() {
    nodeParsers = {
      ...
      "path": function(xmlNode, parentGroup) {
        ...
        var path = (0,_path_js__WEBPACK_IMPORTED_MODULE_9__.createFromString)(d);
...
function parseGradientColorStops(xmlNode, gradient) {
  ...
  while (stop) {
    if (stop.nodeType === 1 && stop.nodeName.toLocaleLowerCase() === "stop") {
      ...
      if (stopOpacity) {
        var rgba = _color_js__WEBPACK_IMPORTED_MODULE_15__.parse(stopColor);
        var stopColorOpacity = rgba && rgba[3];
        if (stopColorOpacity) {
          rgba[3] *= _color_js__WEBPACK_IMPORTED_MODULE_15__.parseCssFloat(stopOpacity);
          stopColor = _color_js__WEBPACK_IMPORTED_MODULE_15__.stringify(rgba, "rgba");
        }
      }
...
function inheritStyle(parent, child) {
  if (parent && parent.__inheritedStyle) {
    ...
    (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.defaults)(child.__inheritedStyle, parent.__inheritedStyle);
  }
}
...
function parseAttributes(xmlNode, el, defsUsePending, onlyInlineStyle, isTextGroup) {
  ...
  (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.each)([
    "lineWidth",
    "opacity",
    "fillOpacity",
    "strokeOpacity",
  ...
  if (inheritedStyle.lineDash) {
    disp.style.lineDash = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.map)(splitNumberSequence(inheritedStyle.lineDash), function(str) {
...
function getFillStrokeStyle(el, method, str, defsUsePending) {
  ...
  if (urlMatch) {
    var url = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.trim)(urlMatch[1]);
...
function parseInlineStyle(xmlNode, inheritableStyleResult, selfStyleResult) {
  ...
  while ((styleRegResult = styleRegex.exec(style)) != null) {
    ...
    var zrInheritableStlAttr = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.hasOwn)(INHERITABLE_STYLE_ATTRIBUTES_MAP, svgStlAttr) ? INHERITABLE_STYLE_ATTRIBUTES_MAP[svgStlAttr] : null;
    if (zrInheritableStlAttr) {
      inheritableStyleResult[zrInheritableStlAttr] = styleRegResult[2];
    }
    var zrSelfStlAttr = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_10__.hasOwn)(SELF_STYLE_ATTRIBUTES_MAP, svgStlAttr) ? SELF_STYLE_ATTRIBUTES_MAP[svgStlAttr] : null;
    if (zrSelfStlAttr) {
...
var SVGPath = (function(_super) {
  (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(SVGPath2, _super);
  function SVGPath2() {
    return _super !== null && _super.apply(this, arguments) || this;
  }
...
function createPathOptions(str, opts) {
  ...
  var innerOpts = (0,_core_util_js__WEBPACK_IMPORTED_MODULE_4__.extend)({}, opts);
  ...
  innerOpts.applyTransform = function(m) {
    (0,_transformPath_js__WEBPACK_IMPORTED_MODULE_3__["default"])(pathProxy, m);
    this.dirtyShape();
  };
  return innerOpts;
}
...
function extendFromString(str, defaultOpts) {
  ...
  var Sub = (function(_super) {
    (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__extends)(Sub2, _super);
    function Sub2(opts) {
...
function clonePath(sourcePath, opts) {
  ...
  if (opts.bakeTransform) {
    (0,_transformPath_js__WEBPACK_IMPORTED_MODULE_3__["default"])(path.path, sourcePath.getComputedTransform());
  } else {
    if (opts.toLocal) {
...
function isDarkMode(backgroundColor) {
  ...
  if (typeof backgroundColor === "string") {
    return (0,_tool_color_js__WEBPACK_IMPORTED_MODULE_6__.lum)(backgroundColor, 1) < _config_js__WEBPACK_IMPORTED_MODULE_7__.DARK_MODE_THRESHOLD;
  } else if (backgroundColor.colorStops) {
    var colorStops = backgroundColor.colorStops;
    var totalLum = 0;
    var len = colorStops.length;
    for (var i = 0; i < len; i++) {
      totalLum += (0,_tool_color_js__WEBPACK_IMPORTED_MODULE_6__.lum)(colorStops[i].color, 1);
    }
    totalLum /= len;
...
var ZRender = (function() {
  function ZRender2(id, dom, opts) {
    ...
    var handlerProxy = !_core_env_js__WEBPACK_IMPORTED_MODULE_0__["default"].node && !_core_env_js__WEBPACK_IMPORTED_MODULE_0__["default"].worker && !ssrMode ? new _dom_HandlerProxy_js__WEBPACK_IMPORTED_MODULE_5__["default"](painter.getViewportRoot(), painter.root) : null;
    var useCoarsePointer = opts.useCoarsePointer;
    var usePointerSize = useCoarsePointer == null || useCoarsePointer === "auto" ? _core_env_js__WEBPACK_IMPORTED_MODULE_0__["default"].touchEventsSupported : !!useCoarsePointer;
  ...
  ZRender2.prototype._flush = function(fromInside) {
    var triggerRendered;
    var start = (0,_animation_Animation_js__WEBPACK_IMPORTED_MODULE_4__.getTime)();
    ...
    var end = (0,_animation_Animation_js__WEBPACK_IMPORTED_MODULE_4__.getTime)();
    if (triggerRendered) {
      this._stillFrameAccum = 0;
