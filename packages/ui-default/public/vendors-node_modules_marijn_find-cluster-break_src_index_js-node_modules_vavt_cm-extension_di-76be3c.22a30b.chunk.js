!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"970d75aa8607cff89eb0648ee23d6fafc2d8eca2"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="c450c66d-877b-476c-bb1d-a73c3bfa2a25",e._sentryDebugIdIdentifier="sentry-dbid-c450c66d-877b-476c-bb1d-a73c3bfa2a25");}catch(e){}}();
(self["webpackChunk_hydrooj_ui_default"] = self["webpackChunk_hydrooj_ui_default"] || []).push([["vendors-node_modules_marijn_find-cluster-break_src_index_js-node_modules_vavt_cm-extension_di-76be3c"],{
...
/***/ "../../node_modules/@vavt/cm-extension/dist/locale/zh-TW.js"
/*!******************************************************************!*\
  !*** ../../node_modules/@vavt/cm-extension/dist/locale/zh-TW.js ***!
  \******************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ZH_TW);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createSmoothScroll: () => (/* binding */ R),
/* harmony export */   debounce: () => (/* binding */ x),
/* harmony export */   deepMerge: () => (/* binding */ v),
/* harmony export */   draggingScroll: () => (/* binding */ P),
/* harmony export */   linkTo: () => (/* binding */ L),
/* harmony export */   randomId: () => (/* binding */ W)
/* harmony export */ });
...
const M = (e) => {
  ...
  return e.replace(/^\?/, "").split("&").forEach((r) => {
    const [o, c] = r.split("=");
    if (o) {
      const s = n ? decodeURIComponent(o) : o, i = n ? decodeURIComponent(c) : c;
      t[s] !== void 0 ? (Array.isArray(t[s]) || (t[s] = [t[s]]), t[s].push(i)) : t[s] = i;
    }
  }), t;
}, H = (e, n = true) => e ? Object.keys(e).map((t) => {
  const r = n ? encodeURIComponent(t) : t;
  if (Array.isArray(e[t]))
    return e[t].map((o) => {
      const c = n ? encodeURIComponent(o) : o;
      return `${r}=${c}`;
    }).join("&");
  {
...
}).join("&") : "", N = (e, n, t = "asc") => e.sort((r, o) => {
  const c = n(r), s = n(o);
  return c === void 0 && s !== void 0 || c === null && s !== void 0 ? t === "asc" ? -1 : 1 : c == null && s === void 0 || s == null ? t === "asc" ? 1 : -1 : S(c) && S(s) ? t == "asc" ? c - s : s - c : t == "asc" ? String(c).localeCompare(String(s), void 0, {
    numeric: true
  }) : String(s).localeCompare(String(c), void 0, {
    numeric: true
  });
}), P = (e) => {
  const n = (t) => {
...
}, W = () => `${Date.now().toString(36)}${Math.random().toString(36).substring(2)}`, S = (e) => {
  if (e == null || ["boolean", "symbol"].includes(typeof e) || /^\s*$/.test(e.toString()))
    return false;
  const n = Number(e);
  return !isNaN(n) && isFinite(n);
}, f = (e) => e !== null && typeof e == "object" && !Array.isArray(e), _ = /* @__PURE__ */ new Set(["__proto__", "constructor", "prototype"]), C = (e) => !_.has(e), v = (e, n, t = {}) => {
  ...
  for (const s of Object.keys(c)) {
    if (!C(s))
      continue;
    const i = c[s], l = o[s];
    r && r(s) ? o[s] = i : Array.isArray(i) && Array.isArray(l) ? o[s] = y(l, i, t) : f(i) && f(l) ? o[s] = v(
      l,
      i,
      t
    ) : o[s] = i;
  ...
  return n.forEach((o, c) => {
    const s = r[c];
    Array.isArray(o) && Array.isArray(s) ? r[c] = y(s, o, t) : f(o) && f(s) ? r[c] = v(
      s,
      o,
      t
    ) : r[c] = o;
  ...
  const { forceScreenWidth: n = false, threshold: t = 768, fallbackToScreenWidth: r = true } = e, o = navigator.userAgent, c = /android|ipad|iphone|ipod|windows phone|blackberry/i.test(o), s = "ontouchstart" in window || navigator.maxTouchPoints > 0, i = window.matchMedia(`(max-width: ${t}px)`).matches;
  return n ? i : c && s ? true : r ? i : false;
};
...
/***/ "../../node_modules/markdown-it-table-of-contents/index.mjs"
/*!******************************************************************!*\
  !*** ../../node_modules/markdown-it-table-of-contents/index.mjs ***!
  \******************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (markdownItTableOfContents);
